            ...
            <div class="p-4 bg-white shadow-sm sm:p-8 sm:rounded-lg" <section>
                <header class="flex items-center justify-between">
                    ...
                    <div class="flex-col items-center justify-center text-center">
                        ...
                        <a href="{{route('dokter.obat.trash')}}" class="btn btn-primary">Data Obat Terhapus</a>
                ...
                @if (session('status'))
                        <div x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 3000)"
                             class="alert alert-success mb-4 text-green-600 p-4 bg-green-100 rounded-lg shadow-md">
                            {{ session('status') }}
                        </div>
                    @endif
