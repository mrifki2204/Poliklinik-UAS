                ...
                <div class="max-w-xl">
                    <section>
                        ...
                        <form class="mt-6" id="formEdit"
                            ...
                            <div id="selectedObatsBox" class="mt-4 p-4 border border-gray-300 rounded-lg bg-gray-50"></div>
                        ...
                        <script>
                            function hitungEditBiaya() {
                                ...
                                const selectedObatsDiv = document.getElementById('selectedObatsBox');
                                let totalBiaya = 150000;

                                selectedObatsDiv.innerHTML = '';

                                selectedOptions.forEach(option => {
                                    const obatName = option.text;
                                    const harga = parseInt(option.getAttribute('data-harga')) || 0;
                                    totalBiaya += harga;
                                    

                                    const obatItem = document.createElement('div');
                                    obatItem.textContent = obatName;
                                    selectedObatsDiv.appendChild(obatItem);
                                });
                                ...
                                hitungEditBiaya(); // Panggil fungsi perhitungan biaya setelah halaman dimuat
                            });
                        </script>
                    </section>
                </div>
